...
def main():
    ...
    try:
        ...
        if args.mode == "train":
            ...
            ##################################################
            horse_embedding = spark.read.parquet("/home/exx/myCode/horse-racing/FoxRiverAIRacing/data/parquet/horse_embedding_data-20250201_0001.parquet")
            main_inference(spark, horse_embedding, jdbc_url, jdbc_properties)

...
def load_base_training_data(spark, jdbc_url, jdbc_properties, parquet_dir):
    ...
    cols_to_impute = ["distance_meters", "prev_speed_rating", "previous_distance", "starts", "previous_class",
                    ...
                    'dist_bk_gate4','sire_roi', 'cond_earnings','cond_fourth','cond_place',
                    'cond_show','cond_starts','cond_win','jock_itm_track','jock_win_track',
                    'jt_itm_percent','jt_itm_track','jt_win_percent','jt_win_track']
    race_cols=("course_cd", "race_date", "race_number")
    train_df = convert_nan_inf_to_null(train_df, cols_to_impute)

...
from src.Predict_Equibase.equibase_load_prediction_data import load_prediction_data_final
from src.Predict_Equibase.equibase_predictions import race_predictions
...
def setup_logging():
    ...
    try:
        ...
        log_file = os.path.join(log_dir, 'equibase_inference_prep.log')

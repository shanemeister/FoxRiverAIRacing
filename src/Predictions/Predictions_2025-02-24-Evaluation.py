...
def write_predictions_to_docx(pred_df, output_docx):
    ...
    for (track_name, course_cd, race_date, race_number), race_df in race_groups:
        ...
        for _, row in race_df.iterrows():
            ...
            cells[3].text = f"{row['YetiRank_top_4_NDCG_top_4']:.2f}"
...
def main():
    ...
    columns_to_select = [
        ...
        "horse_name", "recent_avg_speed", "global_speed_score", "YetiRank_top_4_NDCG_top_4"]
    ...
    pred_df['winning_probability'] = pred_df.groupby(['course_cd', 'race_date', 'race_number'])['YetiRank_top_4_NDCG_top_4'] \

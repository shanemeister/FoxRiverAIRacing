eqb_tpd_codes_to_course_cd = {
    ...
    "CG": "CTD",  # CENTURY DOWNS
    "CTD": "CTD",  # CENTURY DOWNS
    "ED": "CTM",  # CENTURY MILE
    ...
    "RIL": "RIL",  # RILLITO
    "SAF": "SAF",  # GRAHAM COUNTY FAIR @ SAFFORD
    "SON": "SON",  # SANTA CRUZ COUNTY FAIR @ SONOITA
    "TUP": "TUP",  # TURF PARADISE
    "YAV": "YAV",  # YAVAPAI DOWNS
    "DEP": "DEP",  # DESERT PARK
    "EP": "TEP",  # EXHIBITION PARK
    "HST": "HST",  # HASTINGS RACECOURSE
    "KAM": "KAM",  # KAMLOOPS
    "KIN": "KIN",  # KIN PARK
    ...
    "FER": "FER",  # FERNDALE
    "FNO": "FNO",  # FRESNO
    "FPX": "FPX",  # FAIRPLEX PARK
    "HOL": "HOL",  # HOLLYWOOD PARK
    "LA": "TLA",  # LOS ALAMITOS
    "LRC": "LRC",  # LOS ALAMITOS RACE COURSE
    "OSA": "OSA",  # OAK TREE AT SANTA ANITA
    "OTH": "OTH",  # OAK TREE AT HOLLYWOOD PARK
    "OTP": "OTP",  # OAK TREE AT PLEASANTON
    "PLN": "PLN",  # PLEASANTON
    "SAC": "SAC",  # SACRAMENTO
    "SLR": "SLR",  # SAN LUIS REY TRAINING CENTER
    "SOL": "SOL",  # SOLANO
    "SR": "TSR",  # SANTA ROSA
    "STK": "STK",  # STOCKTON
    "79": "DMR",  # DEL MAR
    ...
    "WNT": "WNT",  # WINTERTHUR
    "CRC": "CRC",  # CALDER RACE COURSE
    "GPW": "GPW",  # GULFSTREAM PARK WEST
    "HIA": "HIA",  # HIALEAH PARK
    ...
    "BKF": "BKF",  # BLACK FOOT
    "BOI": "BOI",  # LES BOIS PARK
    "CAS": "CAS",  # CASSIA COUNTY FAIR
    "EMT": "EMT",  # EMMETT
    "JRM": "JRM",  # JEROME COUNTY FAIR
    "ONE": "ONE",  # ONEIDA COUNTY FAIR
    "POD": "POD",  # POCATELLO DOWNS
    "RUP": "RUP",  # RUPERT DOWNS
    "SDY": "SDY",  # SANDY DOWNS
    "AP": "TAP",  # ARLINGTON
    "DUQ": "DUQ",  # DU QUOIN
    ...
    "MAF": "MAF",  # MARIAS FAIR
    "MC": "TMC",  # MILES CITY
    "WMF": "WMF",  # WESTERN MT FAIR
    "YD": "TYD",  # YELLOWSTONE DOWNS
    "BRO": "BRO",  # BROOKHILL FARM
    "CHL": "CHL",  # CHARLOTTE
    "CLM": "CLM",  # CLEMMONS
    "MS": "TMS",  # MILL SPRING

...
import logging
from src.data_ingestion.ingestion_utils import validate_xml, get_text, safe_float, parse_date, safe_int, gen_race_identifier, log_rejected_record, parse_time, update_ingestion_status
